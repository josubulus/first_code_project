...
--
-- Host: localhost:3306
-- Generation Time: Dec 31, 2018 at 05:22 AM
...
(19, '2018-12-31 00:52:46', '   a faire : \r\nsurveiller les réponse de néo soft poei candidature envoyé \r\nrelancer formatin ADRAR en janvier\r\nrelancer adaming mi-janvier \r\n\r\n   en cours :\r\nAttente réponse adaming \r\nattente que lestage soit effectuer \r\n\r\ndemande de POEI pour neosoft envoyer a adaming \r\n\r\n-Objectif : trouver un stage d\'observation : voir les agence de com certain photographe graphiste et imprimerie\r\n\r\n--afficher les erreurs de php quand code movais dans ubuntu', 5),
(21, '2018-12-31 01:21:11', '-ajouter un paramètre class sur les méthod de creation form\r\n-finir le placement des menus dans note \r\n-trouver un affichage pour l\'importance de l\'entreprise \r\n-faire tout les formulaires avec ma classe\r\n-rendre l\'appli responsive \r\n-ajouter un cadre entreprise déjà travailler avec \r\n', 6),
(22, '2018-12-30 21:16:16', 'Objectif: se barrer de France', 7);
...
(9, 'PRODIRIS', '05 34 46 14 48', 'rien', '', '34 Boulevard de Peyramont, 31600 Muret', NULL, '2018-10-18 23:06:40', 4, 1, '2018-10-23 21:49:33', 'l\'entreprise ne prend pas de stagiaire', 1, 5),
(10, 'pixbulle', '+33 (0)5 82 95 18 14', 'pas de mail', '', '24 avenue du grand tétras 31860 Labarthe-sur-Lèze', 'dev web', '2018-10-19 00:41:01', 1, 1, NULL, 'Peut être un particulié, l\'adresse du siège social mène a une maison ', 1, 5),
...
(35, 'agiteo', '05 61 73 63 31 //  06 25 73 19 63', 'contact@agiteo.fr', '', '1355 Route d’Ox\r\n31600 SEYSSES', 'stratégie com internet etc ', '2018-12-06 13:30:08', 4, 1, NULL, 'ne fait plu de site internet', 1, 5),
(36, 'bf production || MURET ', '05 61 56 48 02', 'info@bfproduction.com', '', '4 Quai St Marcet,\r\n31600 MURET', 'dev web com', '2018-12-07 13:22:27', 2, 2, '2018-12-07 14:49:48', 'C\'est bon convention signé \r\nplutot mercredi 12/12 passer avec pré convention a partir de 11h00 du matin \r\nJ\'ai envoyé un mail suite a sont contact téléphonique il doit me rappeler et il est peut être interressé', 3, 5),
(57, 'test', '05 61 05 05 05 ', 'josé@josé.com', 'caca', 'dans l\'espace prout', 'claquette', '2018-12-30 14:28:32', 2, 1, '2018-12-30 19:34:10', 'trop bien ma classe trop la classe ma classe ', 3, 6);
...
(5, 'josubulus', '$2y$10$dyrX1D6ho4incH63BNAORedwqteOE9cd86OFQtSIK/YEKBLeR4d2G', 'jose', '2018-12-24', 0),
(6, 'work', '$2y$10$390K0dN7iBuI8eDxLKFDrOUr6byN9XbVpYjK7wNs5Fkd/UwC0K8YS', 'test', '2018-12-24', 0);
